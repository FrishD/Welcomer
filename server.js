...
client.on("ready", async () => {
  ...
  client.user.setActivity(`New Members!By Legitimarcy Developers`, { type: "PLAYING" });
});
...
client.login('OTU4MzYzNTQyNTM1NDI2MDY4.Gu8J_I.oQC-fwlzTx-HDTA0VHN5cDB1q8hZONFcjqlSaQ').catch(() => console.log(`Invalid Token Is Provided - Please Give Valid Token!`));
